...
(function () {
  ...
  var Widgets = function () {
    ...
    function createPdfDialog(settings) {
      ...
      var cancel_text = has_action_callback ? "Cancel" : "Close";
      ...
      var width = safeGet(settings["width"], 850);
    ...
    this.createPdfDialog = createPdfDialog;
